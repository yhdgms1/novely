...
type ChoiceParams<T> = T extends TypeEssentials<infer $Lang, infer $State, any, any>
	? ChoiceCheckFunctionProps<$Lang, $State>
	: never;

type FunctionParams<T> = T extends TypeEssentials<infer $Lang, infer $State, any, any>
	? FunctionActionProps<$Lang, $State>
	: never;

type InputHandler<T> = T extends TypeEssentials<infer $Lang, infer $State, any, any>
