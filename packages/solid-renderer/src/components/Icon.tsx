...
Icon.Book = () => {
	return (
		<path d="M19.25 5.75a1 1 0 0 0-1-1H14a2 2 0 0 0-2 2v12.5l.828-.828a4 4 0 0 1 2.829-1.172h2.593a1 1 0 0 0 1-1V5.75ZM4.75 5.75a1 1 0 0 1 1-1H10a2 2 0 0 1 2 2v12.5l-.828-.828a4 4 0 0 0-2.829-1.172H5.75a1 1 0 0 1-1-1V5.75Z" />
	);
};
...
Icon.Menu = () => {
	return <path d="M4.75 5.75h14.5M4.75 18.25h14.5M4.75 12h14.5" />;
};

Icon.Close = () => {
	return <path d="m17.25 6.75-10.5 10.5M6.75 6.75l10.5 10.5" />;
};
...
Icon.StopMedia = () => {
	return (
		<path d="M200 40H56a16 16 0 0 0-16 16v144a16 16 0 0 0 16 16h144a16 16 0 0 0 16-16V56a16 16 0 0 0-16-16Zm0 160H56V56h144v144Z" />
	);
};

Icon.Stop = () => {
	return <rect width="12.5" height="12.5" x="5.75" y="5.75" rx="1" />;
};
