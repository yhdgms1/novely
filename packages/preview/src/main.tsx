...
const { createRenderer, Novely, registerScreen, registerMainmenuItem } =
  createSolidRenderer({
    fullscreen: false,
  });
...
const engine = novely({
  ...
  t9n: createT9N({
    ru: {
      ...
      strings: {
        StartText:
          "На улице прекрасный день, ты открываешь глаза и встречаешь...",
    ...
    en: {
      ...
      strings: {
        StartText:
          "It's a beautiful day outside, you open your eyes and meet...",
